...
try{
    ...
    $handle = $link->prepare("select school,no_s from iub where major='$option'"); 
    $handle->execute(); 
    ...
    foreach($result as $row){
        ...
        array_push($dataPoints, array("label"=>$row->school, "y"=>$row->no_s));
...
<head>
	...
	<script>
		...
		var chart = new CanvasJS.Chart("chartContainer1", {
			...
			//exportEnabled: true,
		    title: {
		        text:  "Major wise Student Interest in SECS"
		    },
		    axisY: {
			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="majorwise.php" >Major Wise @ SECS<span class="sr-only">(current)</span></a>
			      </li>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					<div class="card p-5">
					  ...
					  <form action="majorwiseinsecs.php" method="POST">
							  ...
							  <option value="BSc - Electronic and Telecommunication Engineering">BSc - Electronic and Telecommunication Engineering</option>
							  <option value="BSc - Mathematics (Hons)">BSc - Mathematics (Hons)</option>
							  <option value="BSc - Physics (Hons)">BSc - Physics (Hons)</option>
