...
if(isset($_POST["insert"])){
	...
	$sql = "INSERT INTO department (did, mid) VALUES
            ('$did', '$mid')";
		...
		<div class="homcontainer1 container">
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<!-- Default form group -->
						<form method="POST" action="addmajor.php">
						  <!-- Default input -->
						  ...
						  <!-- Default input -->
						  <div class="form-group">
						    <label for="formGroupExampleInput">Major ID</label>
						    <input type="text" class="form-control" name="mid" id="formGroupExampleInput" placeholder="Major ID" required>
						  </div>

						   <button type="submit" name="insert" class="btn btn-info">Add Major</button>
