...
try{
    ...
    $handle = $link->prepare("select school,no_s from iub where year='$option'"); 
    $handle->execute(); 
...
<head>
	...
	window.onload = function () {
		...
		var chart = new CanvasJS.Chart("chartContainer1", {
			...
			//exportEnabled: true,
		    title: {
		        text:  "Yearly School wise Student Interest in SECS"
		    },
		    axisY: {
			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="yearlyschoolwise.php" >Yearly School Wise<span class="sr-only">(current)</span></a>
			      </li>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					<div class="card p-5">
					  ...
					  <form action="yearlyschoolwise.php" method="POST">
