			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="major.php" >Major<span class="sr-only">(current)</a>
			      </li>
				...
				<div class="col-lg-8 col-md-8 col-sm-8">
					<div class="card myschoolcard">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text">You can add, edit, & delete a major</p>
					    <a href="addmajor.php" class="btn btn-info">ADD</a>
					   	 <a href="editmajor.php" class="btn btn-warning">EDIT</a>
					   	  <a href="deletemajor.php" class="btn btn-danger">DELETE</a>
					  </div>
					</div>
				</div>
