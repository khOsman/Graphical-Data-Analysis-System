...
try{
    ...
    $handle = $link->prepare("select semester_no,no_s from iub where year='$option'"); 
    $handle->execute(); 
    ...
    foreach($result as $row){
        ...
        array_push($dataPoints, array("label"=>$row->semester_no, "y"=>$row->no_s));
			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="yearwise.php" >Year Wise<span class="sr-only">(current)</span></a>
			      </li>
