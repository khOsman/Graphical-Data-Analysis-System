			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="dataentry.php" >Data Entry<span class="sr-only">(current)</a>
			      </li>
			      <li class="nav-item">
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="card" style="width: 18rem;">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text">Add a School in this System</p>
					    <a href="school.php" class="btn btn-info">ADD</a>
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="card" style="width: 18rem;">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text">Add a Department in this System</p>
					    <a href="department.php" class="btn btn-info">ADD</a>
					  </div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-4">
					<div class="card" style="width: 18rem;">
					  ...
					  <div class="card-body">
					    ...
					    <p class="card-text">Add a Major in this System</p>
					    <a href="major.php" class="btn btn-info">ADD</a>
					  </div>
					</div>
				</div>
