			   ...
			   <a class="navbar-brand" href="#" target="_blank">Data Analysis</a>
			    ...
			    <ul class="navitem navbar-nav ml-auto mt-2 mt-lg-0">
			      ...
			      <li class="nav-item active">
			        <a class="nav-link" href="addschool.php" >Delete School<span class="sr-only">(current)</a>
			      </li>
					...
					<!-- Default form group -->
						<form method="POST" action="deleteschool.php">
						  ...
						  <div class="form-group">
						   ...
						   <button type="submit" name="insert" class="btn btn-danger">Delete School</button>
